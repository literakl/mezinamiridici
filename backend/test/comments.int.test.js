...
test('Comments API', async () => {
  const pollBody = {
    text: 'First question',
    picture: 'picture.png',
    date: dayjs().subtract(7, 'hour').format(SHORT_DATE_FORMAT),
  };
  ...
  const commentBody = {
    ...
    date: dayjs(poll.data.info.date).add(10, 'minute').format(FULL_DATE_FORMAT),
  };
  ...
  expect(dayjs.utc(pollResponse.data.comments.last, FULL_DATE_FORMAT).local().format(FULL_DATE_FORMAT)).toBe(commentBody.date);
  ...
  commentBody.date = dayjs(poll.data.info.date).add(20, 'minute').format(FULL_DATE_FORMAT);
  ...
  commentBody.date = dayjs(poll.data.info.date).add(30, 'minute').format(FULL_DATE_FORMAT);
  ...
  commentBody.date = dayjs(poll.data.info.date).add(40, 'minute').format(FULL_DATE_FORMAT);
  ...
  commentBody.date = dayjs(poll.data.info.date).add(50, 'minute').format(FULL_DATE_FORMAT);
  ...
  commentBody.date = dayjs(poll.data.info.date).add(60, 'minute').format(FULL_DATE_FORMAT);
  ...
  commentBody.date = dayjs(comment1.data.comment.created).add(1, 'minute').format(FULL_DATE_FORMAT);
  ...
  commentBody.parentId = comment1.data.comment._id;
  commentBody.date = dayjs(comment1.data.comment.created).add(2, 'minute').format(FULL_DATE_FORMAT);
  ...
  commentBody.parentId = comment1.data.comment._id;
  commentBody.date = dayjs(comment1.data.comment.created).add(3, 'minute').format(FULL_DATE_FORMAT);
  ...
  commentBody.parentId = comment1.data.comment._id;
  commentBody.date = dayjs(comment1.data.comment.created).add(4, 'minute').format(FULL_DATE_FORMAT);
  ...
  commentBody.parentId = comment1.data.comment._id;
  commentBody.date = dayjs(comment1.data.comment.created).add(5, 'minute').format(FULL_DATE_FORMAT);
  ...
  commentBody.parentId = comment1.data.comment._id;
  commentBody.date = dayjs(comment1.data.comment.created).add(6, 'minute').format(FULL_DATE_FORMAT);
  ...
  commentBody.date = dayjs(comment2.data.comment.created).add(1, 'hour').format(FULL_DATE_FORMAT);
  ...
  commentBody.parentId = comment2.data.comment._id;
  commentBody.date = dayjs(comment2.data.comment.created).add(2, 'hour').format(FULL_DATE_FORMAT);
  ...
  commentBody.parentId = comment2.data.comment._id;
  commentBody.date = dayjs(comment2.data.comment.created).add(3, 'hour').format(FULL_DATE_FORMAT);
  ...
  commentBody.parentId = comment2.data.comment._id;
  commentBody.date = dayjs(comment2.data.comment.created).add(4, 'hour').format(FULL_DATE_FORMAT);
  ...
  commentBody.date = dayjs(comment4.data.comment.created).add(5, 'minute').format(FULL_DATE_FORMAT);
  ...
  commentBody.parentId = comment4.data.comment._id;
  commentBody.date = dayjs(comment4.data.comment.created).add(10, 'minute').format(FULL_DATE_FORMAT);
  ...
  commentBody.parentId = comment4.data.comment._id;
  commentBody.date = dayjs(comment4.data.comment.created).add(15, 'minute').format(FULL_DATE_FORMAT);
  ...
  commentBody.parentId = comment4.data.comment._id;
  commentBody.date = dayjs(comment4.data.comment.created).add(20, 'minute').format(FULL_DATE_FORMAT);
  ...
  commentBody.parentId = comment4.data.comment._id;
  commentBody.date = dayjs(comment4.data.comment.created).add(25, 'minute').format(FULL_DATE_FORMAT);
  ...
  commentBody.parentId = comment4.data.comment._id;
  commentBody.date = dayjs(comment4.data.comment.created).add(40, 'minute').format(FULL_DATE_FORMAT);
  ...
  commentBody.parentId = comment4.data.comment._id;
  commentBody.date = dayjs(comment4.data.comment.created).add(45, 'minute').format(FULL_DATE_FORMAT);
  ...
  commentBody.date = dayjs(comment6.data.comment.created).add(3, 'minute').format(FULL_DATE_FORMAT);
  ...
  commentBody.parentId = comment6.data.comment._id;
  commentBody.date = dayjs(comment6.data.comment.created).add(6, 'minute').format(FULL_DATE_FORMAT);
  ...
  commentBody.date = dayjs(poll.data.info.date).add(70, 'minute').format(FULL_DATE_FORMAT);
