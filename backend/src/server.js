...
require('./handlers/pages/createContent')(app);
require('./handlers/pages/updateContent')(app);
require('./handlers/pages/getContent')(app);
require('./handlers/pages/deleteContent')(app);
