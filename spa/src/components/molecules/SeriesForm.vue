<template>
  <div>
    <b-form>
      ...
      <b-form-group label="Education:" label-cols-sm="2">
      ...
      <b-form-group label="Vehicles:" label-cols-sm="2">
      ...
      <b-form-group label="Regions:" label-cols-sm="2">
        <b-form-checkbox-group id="region" v-model="group.regions" name="region">
