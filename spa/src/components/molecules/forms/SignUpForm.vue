  ...
  <div class="col-sm-8 offset-sm-2">
    <ValidationObserver v-slot="{ passes, invalid }">
      <form @submit.prevent="passes(submitForm)" v-if="success === false || success === null">
        ...
        <TextInput v-model="email" rules="required|email" :label="$t('sign-up.email-label')" name="email" type="email"/>
        ...
        <Checkbox v-model="personalData" :label="$t('sign-up.personal-data')" name="personal-data" identifier="personalData" />
