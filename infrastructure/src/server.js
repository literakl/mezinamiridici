...
require('./handlers/cms/createCMS')(app);
require('./handlers/cms/updateCMS')(app);
require('./handlers/cms/getCMS')(app);
require('./handlers/cms/getCMSList')(app);
require('./handlers/cms/deleteCMS')(app);
